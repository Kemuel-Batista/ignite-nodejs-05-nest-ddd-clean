/**
 * currentItems: Guarda o valor após adições e remoções -> [1,4,5]
 *   - valores atuais, mesmo tempo valores atuais, não perdemos referência dos itens excluidos ou novos
 * initial: Quais são os dados iniciais, Items do array -> [1,2,3]
 *   - (Anexos da pergunta que quero editar, inicio com anexos pre-existentes)
 * new: Novos anexos -> [4,5]
 * removed: Anexos removidos -> [2,3]
 * Assim fica mais fácil quais operações eu tenho que fazer no banco de dados
 */
